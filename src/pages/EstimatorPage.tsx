                  ...
                  return (
                    <div key={category} className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Annual: {formatAmount(monthlyExpenses[category] * 12)}
                      </p>
                    </div>
                  );
                })}
            ...
            <Card className="gradient-hero text-white overflow-hidden">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-5xl font-bold mb-4">
                  {formatAmount(calculations.totalAnnual)}
                </p>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="rounded-lg bg-white/10 p-3">
                    <p className="text-white/70">Monthly Total</p>
                    <p className="text-xl font-bold">{formatAmount(calculations.monthlyTotal)}</p>
                  </div>
                  <div className="rounded-lg bg-white/10 p-3">
                    <p className="text-white/70">One-Time</p>
                    <p className="text-xl font-bold">{formatAmount(calculations.oneTimeTotal)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>

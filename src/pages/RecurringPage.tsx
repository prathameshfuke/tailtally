  ...
  const handleSubmit = (data: RecurringFormData) => {
    if (editingRecurring) {
      ...
      toast({
        ...
        description: `${formatAmount(data.amount)} monthly expense has been set up.`,
      });
    }
    form.reset();
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card className="gradient-secondary text-white">
          <CardContent className="p-4">
            ...
            <p className="text-3xl font-bold">{formatAmount(totalMonthly * 12)}</p>
          </CardContent>
        </Card>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Monthly Amount ({symbol})</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"

                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                        ...
                        >
                            ...
                            <p className="text-2xl sm:text-3xl font-bold gradient-text-warm mb-1">${stats.budget}</p>
                        ...
                        >
                            ...
                            <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-1">${stats.totalSpent.toFixed(0)}</p>
                        ...
                        >
                            ...
                            <p className="text-2xl sm:text-3xl font-bold text-success mb-1">${stats.left.toFixed(0)}</p>
                        ...
                        >
                            ...
                            <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-1">${stats.dailyAvg.toFixed(0)}</p>
                    ...
                    >
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                <h3 className="text-xl font-bold font-display">Spending Trends</h3>
                                <p className="text-sm text-gray-500 dark:text-muted-foreground">Last 6 months activity</p>
                            </div>
                            <div className="hidden sm:block px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-bold">
                                Total: ${chartData.reduce((sum, d) => sum + d.value, 0).toFixed(0)}
                            </div>
                        </div>
                            ...
                            {recentActivity.map((expense, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <p className="text-sm font-bold flex-shrink-0">-${expense.amount.toFixed(2)}</p>
                                    </motion.div>
                                );
                            })}

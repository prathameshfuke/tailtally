...
export function FeaturesSection() {
  return (
    <section id="features" className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-surface/50">
          ...
          {features.map((feature, index) => (
            ...
            >
              <Card className="h-full border-2 hover:border-primary/50 transition-all hover:shadow-2xl group bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50 overflow-hidden relative">
                ...
                <div className={`absolute -top-20 -right-20 size-40 bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-10 rounded-full blur-3xl transition-opacity duration-500`} />
                ...
                <CardContent className="p-6 sm:p-8 space-y-4 relative z-10">
                  ...
                  <motion.div
                    ...
                    className={`inline-flex size-14 sm:size-16 rounded-2xl bg-gradient-to-br ${feature.color} p-0.5 shadow-lg group-hover:shadow-2xl transition-shadow`}
                  >
